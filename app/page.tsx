...
import ButtonComponent, { ButtonComponentHandle } from '@/components/ui/ButtonComponent';
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (!showIntro && pageContainerRef.current) {
      ...
      const selector = `
        .Heading_container__Mmg3Y,
        .Heading_heading__9fe8J,
        .Heading_dnaDetail__8pYTX,
        .Heading_lineBlockTwo__3RdlC,
        .Heading_lineBlockOne___MR_J,
        .Heading_image__fwq9l,
        .Heading_subheading__iy_dt.scramble,
        .Heading_subheadingLabel__GRUcO,
        .Heading_lineOne__KvOe7,
        .Heading_lineTwo__QRsF4,
        .Heading
      `;
      const elements = pageContainerRef.current.querySelectorAll(selector);
      ...
      gsap.to(elements, {
        ...
        duration: 1,
        stagger: 0.1,
        delay: 0.5, // Slight delay after intro disappears
        ease: "power4.out",
      });
  ...
  return (
    <div ref={pageContainerRef} className="relative">
      {showIntro && (
        <div className="intro-screen fixed inset-0 bg-white text-black flex flex-col items-center justify-center z-50">
          <h1 className="text-lg font-bold mb-4 font-main tracking-[10px] uppercase " style={{opacity: 0}}>The Urgent Issue
          </h1>
          <p className="text-sm font-serif mb-4 w-1/3 text-center tracking-wide opacity-0">
          ...
          <p className="text-sm font-serif mb-4 w-1/3 text-center opacity-0">
...
<p className="text-sm font-serif mb-5 w-1/3 text-center opacity-0">
It is clear that we need to radically change the way we eat.
          </p>
          <ButtonComponent onClick={handleEnterSite}/>
